...
// Module
exports.push([module.i, "\n/* You can add global styles to this file, and also import other style files */\n* {\n  font-family: \"Roboto\", sans-serif;\n}\nbody, html {\n  padding: 0;\n  margin: 0;\n  background-color: #f6f6f6;\n}\nh1, h2 {\n  position: relative;\n  color: #322153;\n}\nh1::before, h2::before {\n  position: absolute;\n  content: \"\";\n  width: 50px;\n  height: 5px;\n  background-color: #84BD5A;\n  bottom: -10px;\n  border-radius: 5px;\n}\nlabel {\n  display: block;\n  width: 100%;\n  color: #666666;\n  margin-top: 24px;\n  margin-bottom: 6px;\n}\ntextarea {\n  display: block;\n  width: calc(100% - 24px);\n  height: 240px;\n  padding: 12px;\n  font-size: 16px;\n  font-weight: 400;\n  line-height: 1.5;\n  color: #495057;\n  background-color: #fff;\n  background-clip: padding-box;\n  border: 1px solid #ced4da;\n  border-radius: 0.25rem;\n  position: relative;\n  flex: 1 1 0;\n}\ninput[type=number] {\n  display: block;\n  width: 100%;\n  height: 38px;\n  padding: 0 12px;\n  font-size: 16px;\n  font-weight: 400;\n  line-height: 1.5;\n  color: #495057;\n  background-color: #fff;\n  background-clip: padding-box;\n  border: 1px solid #ced4da;\n  border-radius: 0 0.25rem 0.25rem 0;\n  position: relative;\n  flex: 1 1 0;\n  margin-left: -1px;\n}\n.input-group {\n  position: relative;\n  display: flex;\n  flex-wrap: wrap;\n  align-items: stretch;\n  width: 100%;\n}\n.input-symbol {\n  display: flex;\n  align-items: center;\n  padding: 0.375rem 0.75rem;\n  margin-bottom: 0;\n  font-size: 1rem;\n  font-weight: 400;\n  line-height: 1.5;\n  color: #495057;\n  text-align: center;\n  white-space: nowrap;\n  background-color: #e9ecef;\n  border: 1px solid #ced4da;\n  border-radius: 0.25rem 0 0 0.25rem;\n}\n.card {\n  display: flex;\n  flex-direction: column;\n  padding: 24px;\n  background-color: #ffffff;\n  width: 100%;\n  margin: 24px;\n}\n.column {\n  width: 40%;\n}\n.column:first-child {\n  margin-right: 32px;\n}\nosc-root {\n  display: flex;\n  justify-content: center;\n}\nosc-home {\n  display: flex;\n  justify-content: center;\n  flex-wrap: wrap;\n  max-width: 1024px;\n}\n@media (max-width: 768px) {\n  .card {\n    width: auto;\n    margin: 24px 24px 0;\n  }\n  .card:last-child {\n    margin-bottom: 24px;\n  }\n\n  .column {\n    display: flex;\n  }\n\n  osc-home {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n  }\n}", "",{"version":3,"sources":["styles.scss"],"names":[],"mappings":";AAAA,8EAAA;AAGA;EACI,iCAAA;AAAJ;AAGA;EACI,UAAA;EACA,SAAA;EACA,yBAAA;AAAJ;AAGA;EACI,kBAAA;EACA,cAAA;AAAJ;AAEI;EACI,kBAAA;EACA,WAAA;EACA,WAAA;EACA,WAAA;EACA,yBAAA;EACA,aAAA;EACA,kBAAA;AAAR;AAIA;EACI,cAAA;EACA,WAAA;EACA,cAAA;EACA,gBAAA;EACA,kBAAA;AADJ;AAIA;EACI,cAAA;EACA,wBAAA;EACA,aAAA;EACA,aAAA;EACA,eAAA;EACA,gBAAA;EACA,gBAAA;EACA,cAAA;EACA,sBAAA;EACA,4BAAA;EACA,yBAAA;EACA,sBAAA;EACA,kBAAA;EACA,WAAA;AADJ;AAIA;EACI,cAAA;EACA,WAAA;EACA,YAAA;EACA,eAAA;EACA,eAAA;EACA,gBAAA;EACA,gBAAA;EACA,cAAA;EACA,sBAAA;EACA,4BAAA;EACA,yBAAA;EACA,kCAAA;EACA,kBAAA;EACA,WAAA;EACA,iBAAA;AADJ;AAKI;EACI,kBAAA;EACA,aAAA;EACA,eAAA;EACA,oBAAA;EACA,WAAA;AAFR;AAKI;EACI,aAAA;EACA,mBAAA;EACA,yBAAA;EACA,gBAAA;EACA,eAAA;EACA,gBAAA;EACA,gBAAA;EACA,cAAA;EACA,kBAAA;EACA,mBAAA;EACA,yBAAA;EACA,yBAAA;EACA,kCAAA;AAHR;AAOA;EACI,aAAA;EACA,sBAAA;EACA,aAAA;EACA,yBAAA;EACA,WAAA;EACA,YAAA;AAJJ;AAQA;EACI,UAAA;AALJ;AAOI;EACI,kBAAA;AALR;AASA;EACI,aAAA;EACA,uBAAA;AANJ;AASA;EACI,aAAA;EACA,uBAAA;EACA,eAAA;EACA,iBAAA;AANJ;AASA;EACI;IACI,WAAA;IACA,mBAAA;EANN;EAQM;IACI,mBAAA;EANV;;EAUE;IACI,aAAA;EAPN;;EAUE;IACI,aAAA;IACA,sBAAA;IACA,uBAAA;EAPN;AACF","file":"styles.scss","sourcesContent":["/* You can add global styles to this file, and also import other style files */\n@import url('https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap');\n\n* {\n    font-family: 'Roboto', sans-serif;\n}\n\nbody, html {\n    padding: 0;\n    margin: 0;\n    background-color: #f6f6f6;\n}\n\nh1, h2 {\n    position: relative;\n    color: #322153;\n\n    &::before {\n        position: absolute;\n        content: \"\";\n        width: 50px;\n        height: 5px;\n        background-color: #84BD5A;\n        bottom: -10px;\n        border-radius: 5px;\n    }\n}\n\nlabel {\n    display: block;\n    width: 100%;\n    color: #666666;\n    margin-top: 24px;\n    margin-bottom: 6px;\n}\n\ntextarea {\n    display: block;\n    width: calc(100% - 24px);\n    height: 240px;\n    padding: 12px;\n    font-size: 16px;\n    font-weight: 400;\n    line-height: 1.5;\n    color: #495057;\n    background-color: #fff;\n    background-clip: padding-box;\n    border: 1px solid #ced4da;\n    border-radius: .25rem;\n    position: relative;\n    flex: 1 1 0;\n}\n\ninput[type='number'] {\n    display: block;\n    width: 100%;\n    height: 38px;\n    padding: 0 12px;\n    font-size: 16px;\n    font-weight: 400;\n    line-height: 1.5;\n    color: #495057;\n    background-color: #fff;\n    background-clip: padding-box;\n    border: 1px solid #ced4da;\n    border-radius: 0 .25rem .25rem 0;\n    position: relative;\n    flex: 1 1 0;\n    margin-left: -1px;\n}\n\n.input {\n    &-group {\n        position: relative;\n        display: flex;\n        flex-wrap: wrap;\n        align-items: stretch;\n        width: 100%;\n    }\n\n    &-symbol {\n        display: flex;\n        align-items: center;\n        padding: .375rem .75rem;\n        margin-bottom: 0;\n        font-size: 1rem;\n        font-weight: 400;\n        line-height: 1.5;\n        color: #495057;\n        text-align: center;\n        white-space: nowrap;\n        background-color: #e9ecef;\n        border: 1px solid #ced4da;\n        border-radius: .25rem 0 0 .25rem;\n    }\n}\n\n.card {\n    display: flex;\n    flex-direction: column;\n    padding: 24px;\n    background-color: #ffffff;\n    width: 100%;\n    margin: 24px;\n\n}\n\n.column {\n    width: 40%;\n\n    &:first-child {\n        margin-right: 32px;\n    }\n}\n\nosc-root {\n    display: flex;\n    justify-content: center;\n}\n\nosc-home {\n    display: flex;\n    justify-content: center;\n    flex-wrap: wrap;\n    max-width: 1024px;\n}\n\n@media (max-width: 768px) {\n    .card {\n        width: auto;\n        margin: 24px 24px 0;\n\n        &:last-child {\n            margin-bottom: 24px;\n        }\n    }\n\n    .column {\n        display: flex;\n    }\n\n    osc-home {\n        display: flex;\n        flex-direction: column;\n        justify-content: center;\n    }\n}\n"]}]);
// Exports
